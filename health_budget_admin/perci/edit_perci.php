...
?>
<?php
// Mendapatkan nilai $kode_ci dari input POST
$kode_ci = $_GET['kode_ci'];

// Pastikan $kode_ci tidak kosong sebelum menggunakan
if (!empty($kode_ci)) {
    // Kode lainnya
} else {
    echo "ID Perci tidak ditemukan.";
}
// Jalankan query untuk mendapatkan data yang ingin ditampilkan
$sql= mysqli_query($conn, "SELECT * FROM anggaran_perci WHERE kode_ci=$kode_ci");
// $sql = "SELECT * FROM anggaran_perci WHERE kode_ci = $kode_ci";
          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="input-group input-group-outline my-3">
                    <input class="form-control" type="hidden"  name="id_perci" value="<?php echo $data['id_perci']?>">
        
                </div>
                <div class="input-group input-group-outline my-3">
                    <input class="form-control" type="hidden"  name="kode_ci" value="<?php echo $data['kode_ci']?>">
        
                </div>
                <div class="input-group input-group-outline my-3">
                    <input class="form-control" type="text"  name="uraian" value="<?php echo $data['uraian']?>">
