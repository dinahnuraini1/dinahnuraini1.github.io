   ...
   <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    ...
    <div class="d-flex justify-content-center align-items-center">
      <div class="card my-4" style="width: 300px;">
        <div class="card-body">
          <form action="pendapatan.php" method="GET"> <!-- Pastikan form action sesuai -->
        ...
        <div class="col-12">
          <div>
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div><a href="tambah_pendapatan.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Tambah Data</a>
            </div>
          </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                          <a href="../health_budget_admin/edit_pendapatan.php?id_pendapatan=<?= $baris['id_pendapatan']; ?>"><span class="badge badge-sm bg-gradient-success">Edit </span></a>
                                          <a href="../health_budget_admin/delete_pendapatan.php?id=<?php echo $baris['id_pendapatan']; ?>" onclick="return confirm('anda yakin?')"><span class="badge badge-sm bg-gradient-danger">Delete</span></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <tr>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td class="text-center text-sm">Klinik Mediska Madiun</th>
                              ...
                              <tr>
                                ...
                                <td class="text-center text-sm">Klinik Mediska Kertosono</td>
                              ...
                              <tr>
                                ...
                                <td class="text-center text-sm">Klinik Mediska Kediri</td>
                            ...
                            <tr>
                                ...
                                <td class="text-center text-sm">Klinik Mediska Blitar</td>
