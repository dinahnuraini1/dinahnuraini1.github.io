                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    ...
                                    <form action="action_tambah_pendapatan.php" method="POST" class="login-email">
                                        <div class="input-group input-group-outline my-3 position-relative">
                                            <select class="form-select" name="klinik" required>
                                                <option value="">Pilih Klinik</option>
                                                <option value="Mediska Madiun">Mediska Madiun</option>
                                                <option value="Mediska Kertosono">Mediska Kertosono</option>
                                                <option value="Mediska Kediri">Mediska Kediri</option>
                                                <option value="Mediska Blitar">Mediska Blitar</option>
                                            </select>
                                        </div>
                                        <div class="input-group input-group-outline my-3 position-relative">
                                        ...
                                        <div class="input-group input-group-outline my-3 position-relative">
                                            ...
                                            <input class="form-control" type="number" name="kapitasi" placeholder="Masukkan jumlah kapitasi" required>
                                        </div>
                                        <div class="input-group input-group-outline my-3 position-relative">
                                            
                                            <input class="form-control" type="number" name="non_kapitasi" placeholder="Masukkan jumlah non kapitasi" required>
                                        </div>
                                        <div class="input-group text-center">
                                            <button name="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Submit</button>
                                            <a href="../health_budget_admin/pendapatan.php" class="btn btn-danger btn-block w-100 my-4 mb-2">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
