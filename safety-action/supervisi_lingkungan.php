  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="supervisi_lingkungan.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="container-fluid py-1 px-3">
    ...
    <div class="d-flex justify-content-center align-items-center">
      <div class="card my-4" style="width: 300px;">
        <div class="card-body">
          <form action="supervisi_lingkungan.php" method="GET"> <!-- Pastikan form action sesuai -->
              ...
              <div class="flex-grow-1 pr-1">
                <div class="form-group mb-0">
                  <select name="tahun" class="form-control" id="tahunSelect">
                    ...
                    $sqlTahun = "SELECT DISTINCT YEAR(tanggal) AS tahun FROM supervisi_lingkungan ORDER BY tahun ASC";
        ...
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index">
                    ...
                    <h6 class="text-white text-capitalize ps-3 mb-0">Hasil Supervisi Lingkungan</h6>
                      <div class="text-white text-capitalize ps-3">  <a href="tambah_supervisi_lingkungan.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Tambah Data</a></div>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-sm">Air</th>
                                    <th class="text-center text-sm">Pencahayaan</th>
                                    <th class="text-center text-sm">Kebisingan</th>
                                    <th class="text-center text-sm">Getaran</th>
                            ...
                            <tbody>
                            <?php 
                              $sql1 = "SELECT id, tanggal, unit_kerja, air, pencahayaan, kebisingan, getaran, rekomendasi FROM supervisi_lingkungan WHERE YEAR(tanggal) = '$tahun'";
                              ...
                              while($baris = mysqli_fetch_assoc($hasil)){ 
                                  $total_pencahayaan += $baris['pencahayaan'];
                                  $total_kebisingan += $baris['kebisingan'];
                                  $total_getaran += $baris['getaran'];
                              ?>
                             <tr>
                              ...
                              <td class="text-center text-sm"><?= $baris['air']; ?></td>
                              <td class="text-center text-sm"><?= $baris['pencahayaan']; ?></td>
                              <td class="text-center text-sm"><?= $baris['kebisingan']; ?></td>
                              <td class="text-center text-sm"><?= $baris['getaran']; ?></td>
                              <td class="text-center text-sm"><?= $baris['rekomendasi']; ?></td>
                              <td class="align-middle text-center text-sm">
                                  <a href="edit_supervisi_lingkungan.php?id=<?= $baris['id']; ?>">
                                  <span class="badge badge-sm bg-gradient-success">Edit</span>
                                </a>
                                  <a href="delete_supervisi_lingkungan.php?id=<?= $baris['id']; ?>" onclick="return confirm('Anda yakin?')">
                          ...
                          <tfoot>
                            <tr>
                              <th colspan="4" class="text-center text-sm">Jumlah</th>
                              <th class="text-center text-sm"><?= $total_pencahayaan; ?></th>
                              <th class="text-center text-sm"><?= $total_kebisingan; ?></th>
                              <th class="text-center text-sm"><?= $total_getaran; ?></th>
