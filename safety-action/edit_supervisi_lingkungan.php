...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM supervisi_lingkungan WHERE id = ?";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    ...
                                    <form class="user" method="post" action="pengeditan_supervisi_lingkungan.php">
                                        ...
                                        <div class="form-group">
                                        <label for="">Air</label>
                                            <input type="text" class="form-control form-control-user" name="air" placeholder="Air" value="<?php echo $data['air']; ?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="">Pencahayaan</label>
                                            <input type="number" class="form-control form-control-user" name="pencahayaan" placeholder="Pencahayaan" value="<?php echo $data['pencahayaan']; ?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="">Kebisingan</label>
                                            <input type="number" class="form-control form-control-user" name="kebisingan" placeholder="Kebisingan" value="<?php echo $data['kebisingan']; ?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="">Getaran</label>
                                            <input type="number" class="form-control form-control-user" name="getaran" placeholder="Getaran" value="<?php echo $data['getaran']; ?>">
                                        </div>
                                        <div class="form-group">
