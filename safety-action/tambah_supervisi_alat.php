                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    ...
                                    <form class="user" method="post" action="action_supervisi_alat.php">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" name="apd" placeholder="APD" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" name="apar" placeholder="APAR" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" name="p3k" placeholder="P3K" required>
                                        </div>
                                        <div class="form-group">
