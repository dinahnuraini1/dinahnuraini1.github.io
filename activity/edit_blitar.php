                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-3 pb-4 pt-4">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Edit Timeline Kepala Klinik Mediska Blitar</h1>
                                            </div>

                                            <form class="user" method="post" action="proses_edit_blitar.php" onsubmit="return validateForm()" enctype="multipart/form-data">
