...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM pic_manager WHERE id = '$id'";
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-3 pb-4 pt-4">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Edit Timeline Manager Unit Kesehatan</h1>
                                            </div>

                                            <form class="user" method="post" action="proses_edit_manager.php" onsubmit="return validateForm()" enctype="multipart/form-data">
