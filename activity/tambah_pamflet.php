                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    ...
                                    <form class="user" method="post" enctype="multipart/form-data" action="proses_tambah_pamflet.php">
                                        ...
                                        <a href="dashboard.php" class="btn btn-danger btn-user btn-block">Kembali</a>
                                    </form>
