...
?>
        ...
        <head>
            ...
            <title>Edit Pantauan Kesehatan</title>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-3 pb-4 pt-4">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Edit Pantauan Kesehatan</h1>
                                            </div>

                                            <form class="user" method="post" action="proses_edit_pantauan.php" onsubmit="return validateForm()" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-user" name="nama" id="nama" value="<?php echo $row['nama']; ?>">
                                                </div><br>
                                                <div class="form-group">
                                                    <label for="nipp">Nipp:</label>
                                                    <input class="form-control form-control-user" type="number" name="nipp" id="nipp" value="<?php echo $row['nipp']; ?>">
                                                </div><br>
                                                <div class="form-group">
                                                    <label for="deskripsi">Deskripsi:</label>
                                                    <textarea class="form-control form-control-user" maxlength="100" id="deskripsi" name="deskripsi" maxlength="100" rows="4"><?php echo $row['deskripsi']; ?></textarea>
