                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-3 pb-4 pt-4">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Edit Home and Hospital Visit</h1>
                                            </div>

                                            <form class="user" method="post" action="proses_edit_home.php" onsubmit="return validateForm()" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control form-control-user" id="deskripsi" name="deskripsi" maxlength="200" rows="4"><?php echo $row['deskripsi']; ?></textarea>
                                                    <p style="color: red; font-style:italic;">*max 200 kata</p>
                                                </div>
                                                <div class="form-group">
                                                    <label for="rekomendasi">Rekomendasi:</label>
                                                    <textarea class="form-control form-control-user" id="rekomendasi" Name="rekomendasi" maxlength="200" rows="4"><?php echo $row['rekomendasi'] ?></textarea>
                                                </div><br>
                                                <div class="form-group">
