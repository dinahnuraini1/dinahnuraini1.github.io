                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Tambah Home and Hospital Visit</h1>
                                    </div>
                                    <form class="user" method="post" id="nilaiForm" enctype="multipart/form-data" action="proses_tambah_home.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="nipp" name="nipp" min="0" required>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-user" name="deskripsi" id="deskripsi" maxlength="200" rows="4"></textarea>
