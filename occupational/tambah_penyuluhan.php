                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Tambah Penyuluhan Kesehatan</h1>
                                    </div>
                                    <form class="user" method="post" id="nilaiForm" enctype="multipart/form-data" action="proses_tambah_penyuluhan.php">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <p style="color: red; font-style:italic;">*min:1900 max:2099</p>
                                        </div> -->
                                        <div class="form-group">
                                            <label for="tanggal">Tanggal Penyuluhan:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tema" name="tema" maxlength="100" required>
                                            <p style="color: red; font-style:italic;">*max 100 kata</p>
                                        </div>
