...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM rujukan WHERE id = ?";
    ...
    if ($data = mysqli_fetch_assoc($result)) {
        ...
        echo "
            ...
            window.location.href = 'jumlah_rujukan.php';
            </script>
        ";
        exit;
    }
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-3 pb-4 pt-4">
                                    ...
                                    <form class="user" method="post" action="pengeditan_rujukan.php">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select" name="jenis_rujukan" required>
                                                    ...
                                                    <option value="RJTL" <?php echo $data['jenis_rujukan'] == 'RJTL' ? 'selected' : ''; ?>>Rujukan Pasien Rawat Jalan Tingkat Lanjut (RJTL)</option>
                                                    <option value="RI" <?php echo $data['jenis_rujukan'] == 'RI' ? 'selected' : ''; ?>>Rujukan Pasien Rawat Inap (RI) </option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
