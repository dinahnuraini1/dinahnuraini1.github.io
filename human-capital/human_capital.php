                ...
                <div class="row">
                    <div class="col-md-15">
                        <div class="table-responsive"> <!-- Tambahkan kelas table-responsive untuk mendukung tampilan responsif -->
                            <table class="table table-bordered table-sm" style="text-align: center;"> <!-- Tambahkan kelas table-sm untuk merampingkan tabel -->
                                <thead>
                                    <tr>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <!-- Tombol edit -->
                                                    <a href="edit.php?id=<?php echo $row['nipp']; ?>">
                                                        <i class="fa-solid"><img src="../assets/img/icon/pen.png" alt="" width="30" height="30"></i>
                                                    </a>
                                                    <!-- Tombol hapus -->
                                                    <a href="hapus.php?id=<?php echo $row['nipp']; ?>">
