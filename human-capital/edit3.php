...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM user_mediska_madiun WHERE nipp = '$id'";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-3 pb-4 pt-4">
                                            ...
                                            <form class="user" method="post" action="proses_edit3.php" onsubmit="return validateForm()" enctype="multipart/form-data">
