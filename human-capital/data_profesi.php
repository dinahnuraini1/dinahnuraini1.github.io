        ...
        <div class="breadcrumbs d-flex align-items-center" style="background-image: url('../assets/img/depan/4.jpg');">
            <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
                ...
                <ol>
                    ...
                    <li><a href="human_capital.php">Human Capital</a></li>
                    <li>Data Profesi</li>
                </ol>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="services-list">
                            <a href="human_capital.php">Data & Foto Management</a>
                            <a href="data_pekerja.php">Data Pekerja</a>
                            <a href="data_profesi.php" class="active">Data Profesi</a>
                        </div>

                        <!-- <h4>Enim qui eos rerum in delectus</h4> -->
                        <p style="text-align: justify">"Kesehatan pekerja adalah aset terbesar dalam setiap organisasi. Menjaga kesehatan dan kesejahteraan mereka adalah investasi jangka panjang yang penting bagi kesuksesan perusahaan."</p>
                    </div>

                    <div class="col-lg-8">
                        <img src="../assets/img/depan/3.jpg" alt="" class="img-fluid services-img">
        ...
        <div class="footer-content position-relative">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-1" style="text-align: justify; margin-top:30px; line-height:30px;">
                        <p class="text-justify">PT. Kereta Api (Persero) Daerah Operasi 7 Madiun atau disingkat dengan DAOP VII MN adalah salah satu daerah operasi perkereta-apian Indonesia,
                            di bawah lingkungan PT Kereta Api (Persero) yang berada di bawah
                            Direksi PT Kereta Api (Persero) dipimpin oleh seorang Kepala Daerah Operasi (Kadaop) yang berada di bawah dan bertanggung jawab kepada Direksi PT Kereta Api (Persero).</p>
