...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['gambar']['name']) {
        ...
        $query =
            "UPDATE user_mediska_blitar SET kedudukan='$kedudukan', jabatan='$jabatan', nama='$nama', nipp='$nipp', status='$status', tempat_lhr='$tempat_lhr', tgl='$tgl', pend='$pend', profesi='$profesi', gambar='$file_name' WHERE id='$id'";
    } else {
        // Query untuk mengupdate data pekerja tanpa mengubah gambar
        $query = "UPDATE user_mediska_blitar SET kedudukan='$kedudukan', jabatan='$jabatan', nama='$nama',nipp='$nipp', status='$status', tempat_lhr='$tempat_lhr', tgl='$tgl', pend='$pend', profesi='$profesi' WHERE id='$id'";
    }
